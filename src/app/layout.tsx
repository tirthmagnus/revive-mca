...
export const metadata: Metadata = {
  title: "Premium business advisory for MCA payment pressure",
  description: "Confidential business-focused support for owners evaluating merchant cash advance restructuring, negotiation, and resolution options.",
};
